...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    {0xCCu, 0xBBu, 0xAAu, 0x50u, 0xA0u, 0x00u}, /* uint8* direct_addr */
...
CYBLE_GAPP_DISC_DATA_T cyBle_discoveryData =
{
    ...
    0x45u, 0x20u, 0x4Cu, 0x61u, 0x62u, 0x20u, 0x34u, 0x48u,
    0x41u, 0x05u, 0x03u, 0xB5u, 0xCAu, 0xBBu, 0xCBu, 0x00u,
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0xCCu, 0xBBu, 0xAAu, 0x50u, 0xA0u, 0x00u}, 0x00u };

...
#define CYBLE_CAPSENSE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_DECL_HANDLE   (0x000Du) /* Handle of CapSense Slider Characteristic characteristic declaration */
#define CYBLE_CAPSENSE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHAR_HANDLE   (0x000Eu) /* Handle of CapSense Slider Characteristic characteristic */
#define CYBLE_CAPSENSE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */

#define CYBLE_RGB_LED_SERVICE_SERVICE_HANDLE   (0x0011u) /* Handle of RGB LED Service service */
#define CYBLE_RGB_LED_SERVICE_RGB_LED_CHARACTERISTIC_DECL_HANDLE   (0x0012u) /* Handle of RGB LED Characteristic characteristic declaration */
